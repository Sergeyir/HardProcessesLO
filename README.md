...
This is a simple projects that helps to study hard LO processes in p+p collisions at high energy. The goal of this project is a numerical calculation of $d \sigma/dp_{T}$ and $d \sigma / d \Delta y$ of partons that originate from hard LO processes. The calculation is performed in 3 different ways: 
- **Analytic**: integration of the factorization formula of hard LO p+p interaction
...
ROOT6, LHAPDF6, PYTHIA8, and FASTJET3 have to be compiled with python3. For more information see [Installation tutorial](INSTALLATION_TUTORIAL.md).

# Analytic calculation

Using the factorization formula for $d \sigma / dy_{1} dy_{2} dp^2_{T}$ for hard LO $p+p$ process from [1](#sources) (Eq.205), one can obtain
